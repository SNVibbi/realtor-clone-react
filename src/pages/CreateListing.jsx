...
function CreateListing() {
  ...
  return (
    <main className='max-w-md px-2 mx-auto'>
      ...
      <form>
        <p className='text-lr mt-6 font-semibold'>Sell / Rent</p>
        <div className='flex'>
        ...
        <div className='flex space-x-6 mb-6'>
         ...
         <p className='text-lr mt-6 font-semibold'>Parking spot</p>
        <div className='flex'>
        ...
        <p className='text-lr mt-6 font-semibold'>Furnished</p>
        <div className='flex'>
        ...
        <p className='text-lr font-semibold'>Offer</p>
